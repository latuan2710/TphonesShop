...
+function(t) {
    ...
    s.prototype.close = function(e) {
        ...
        t.support.transition && a.hasClass("fade") ? a.one("bsTransitionEnd", i).emulateTransitionEnd(s.TRANSITION_DURATION) : i())
    }
    ;
    var n = t.fn.alert;
    t.fn.alert = e,
...
+function(t) {
    ...
    function e(e) {
        return this.each(function() {
            ...
            "number" == typeof e ? n.to(e) : a ? n[a]() : o.interval && n.pause().cycle()
        })
    }
    var i = function(e, i) {
        this.$element = t(e),
    ...
    a.prototype.toggle = function(s) {
        ...
        if (!n.is(".disabled, :disabled")) {
            ...
            !a) {
                ...
                if (o.trigger(s = t.Event("show.bs.dropdown", r)),
